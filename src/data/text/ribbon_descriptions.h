const u8 gRibbonDescriptionPart1_Champion[] = _("챔피언에게 이겨서");
const u8 gRibbonDescriptionPart2_Champion[] = _("전당등록한 기념리본");
const u8 gRibbonDescriptionPart1_CoolContest[] = _("근사함콘테스트");
const u8 gRibbonDescriptionPart1_BeautyContest[] = _("아름다움콘테스트");
const u8 gRibbonDescriptionPart1_CuteContest[] = _("귀여움콘테스트");
const u8 gRibbonDescriptionPart1_SmartContest[] = _("슬기로움콘테스트");
const u8 gRibbonDescriptionPart1_ToughContest[] = _("강인함콘테스트");
const u8 gRibbonDescriptionPart2_NormalRank[] = _("노말랭크 우승!");
const u8 gRibbonDescriptionPart2_SuperRank[] = _("슈퍼랭크 우승!");
const u8 gRibbonDescriptionPart2_HyperRank[] = _("하이퍼랭크 우승!");
const u8 gRibbonDescriptionPart2_MasterRank[] = _("마스터랭크 우승!");
const u8 gRibbonDescriptionPart1_Winning[] = _("배틀타워 레벨50에서");
const u8 gRibbonDescriptionPart2_Winning[] = _("연승한 기념리본");
const u8 gRibbonDescriptionPart1_Victory[] = _("배틀타워 레벨100에서");
const u8 gRibbonDescriptionPart2_Victory[] = _("연승한 기념리본");
const u8 gRibbonDescriptionPart1_Artist[] = _("호화로운 초상화의 모델이");
const u8 gRibbonDescriptionPart2_Artist[] = _("된 기념리본");
const u8 gRibbonDescriptionPart1_Effort[] = _("많이 노력하고 있는");
const u8 gRibbonDescriptionPart2_Effort[] = _("포켓몬에게 수여되는 리본");
