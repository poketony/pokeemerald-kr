const u8 gGiftRibbonDescriptionPart1_2003RegionalTourney[] = _("2003년 지방 대회");
const u8 gGiftRibbonDescriptionPart2_Champion[] = _("우승 기념리본");
const u8 gGiftRibbonDescriptionPart1_2003NationalTourney[] = _("2003년 전국 대회");
const u8 gGiftRibbonDescriptionPart1_2003GlobalCup[] = _("2003년 월드컵");
const u8 gGiftRibbonDescriptionPart2_RunnerUp[] = _("준우승 기념리본");
const u8 gGiftRibbonDescriptionPart2_Semifinalist[] = _("베스트4 기념리본");
const u8 gGiftRibbonDescriptionPart1_2004RegionalTourney[] = _("2004년 지방 대회");
const u8 gGiftRibbonDescriptionPart1_2004NationalTourney[] = _("2004년 전국 대회");
const u8 gGiftRibbonDescriptionPart1_2004GlobalCup[] = _("2004년 월드컵");
const u8 gGiftRibbonDescriptionPart1_2005RegionalTourney[] = _("2005년 지방 대회");
const u8 gGiftRibbonDescriptionPart1_2005NationalTourney[] = _("2005년 전국 대회");
const u8 gGiftRibbonDescriptionPart1_2005GlobalCup[] = _("2005년 월드컵");
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("포켓몬 배틀 컵");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("참가 기념리본");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("포켓몬리그");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("어드밴스 컵");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("포켓몬 대회에");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("참가한 기념리본");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("포켓몬 이벤트에");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("포켓몬 축제에");
const u8 gGiftRibbonDescriptionPart1_DifficultyClearing[] = _("곤란과 싸워 이긴");
const u8 gGiftRibbonDescriptionPart2_Commemorative[] = _("기념리본");
const u8 gGiftRibbonDescriptionPart1_ClearingAllChallenges[] = _("모든 고난을");
const u8 gGiftRibbonDescriptionPart2_ClearingAllChallenges[] = _("극복한 기념리본");
const u8 gGiftRibbonDescriptionPart1_100StraightWin[] = _("100명에게 승리 달성");
const u8 gGiftRibbonDescriptionPart1_DarknessTower[] = _("어둠탑 클리어");
const u8 gGiftRibbonDescriptionPart1_RedTower[] = _("붉은 탑 클리어");
const u8 gGiftRibbonDescriptionPart1_BlackironTower[] = _("무쇠탑 클리어");
const u8 gGiftRibbonDescriptionPart1_FinalTower[] = _("최후의 탑 클리어");
const u8 gGiftRibbonDescriptionPart1_LegendMaking[] = _("전설을 만든");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("포켓몬센터 도쿄");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("포켓몬센터 오사카");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("포켓몬센터 나고야");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("포켓몬센터 뉴욕");
const u8 gGiftRibbonDescriptionPart1_SummerHolidays[] = _("여름 방학 기념리본");
const u8 gGiftRibbonDescriptionPart2_EmptyString[] = _("");
const u8 gGiftRibbonDescriptionPart1_WinterHolidays[] = _("겨울 방학 기념리본");
const u8 gGiftRibbonDescriptionPart1_SpringHolidays[] = _("봄 방학 기념리본");
const u8 gGiftRibbonDescriptionPart1_Evergreen[] = _("크리스마스 기념리본");
const u8 gGiftRibbonDescriptionPart1_SpecialHoliday[] = _("기념일 기념리본");
const u8 gGiftRibbonDescriptionPart1_HardWorker[] = _("열심히 한 기념리본");
const u8 gGiftRibbonDescriptionPart1_LotsOfFriends[] = _("친구 가득 기념리본");
const u8 gGiftRibbonDescriptionPart1_FullOfEnergy[] = _("기운 가득 기념리본");
const u8 gGiftRibbonDescriptionPart1_LovedPokemon[] = _("매우 좋아하는 포켓몬에게");
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("달려 있는 기념리본");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("포켓몬을 매우 좋아하는 것을");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("증명하는 기념리본");
