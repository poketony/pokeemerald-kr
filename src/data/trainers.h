const struct Trainer gTrainers[] = {
    ...
    [TRAINER_GABRIELLE_1] =
    {
        ...
        .trainerName = _("GABRIELLE"), // origin
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE,
