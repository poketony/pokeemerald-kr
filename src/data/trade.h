...
static const u8 sText_SpaceMove[] = _(" 기술"); // unused
...
static const u8 sText_IsThisTradeOkay[] = _("교환하겠습니까?");
static const u8 sText_Cancel[] = _("취소");
static const u8 sText_ChooseAPkmn[] = _("포켓몬을 선택해 주십시오");
static const u8 sText_Summary[] = _("능력치를 본다");
static const u8 sText_Trade[] = _("교환에 내보낸다");
static const u8 sText_CancelTrade[] = _("교환을 취소하겠습니까?");
static const u8 sJPText_PressBButtonToQuit[] = _("B 버튼으로 돌아갑니다");
static const u8 sText_Summary2[] = _("능력치를 본다");
static const u8 sText_Trade2[] = _("교환에 내보낸다");
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GREY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GREY}통신 대기 중!\n잠시 기다려 주십시오");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GREY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GREY}교환이\n취소되었습니다!");
static const u8 sText_OnlyPkmnForBattle[] = _("그 포켓몬을 교환하면\n배틀을 할 수 없게 돼!");
static const u8 sText_WaitingForYourFriend[] = _("{COLOR DARK_GREY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GREY}친구가 종료하기를\n기다리고 있습니다...");
static const u8 sText_YourFriendWantsToTrade[] = _("친구는 포켓몬을\n교환하고 싶어하는 것 같습니다!");
