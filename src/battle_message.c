...
static const u8 sText_ABoosted[] = _(" 많은 양의");
...
static const u8 sText_UseNextPkmn[] = _("다음 포켓몬을 사용하겠습니까?");
static const u8 sText_AttackMissed[] = _("그러나 {B_ATK_NAME_WITH_PREFIX}의\n공격은 빗나갔다!");
static const u8 sText_PkmnProtectedItself[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n공격으로부터 몸을 지켰다!");
...
static const u8 sText_AttackerFainted[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 쓰러졌다!\p");
static const u8 sText_TargetFainted[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 쓰러졌다!\p");
...
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의\n{B_SCR_ACTIVE_ABILITY} 때문에 도망칠 수 없다!\p");
static const u8 sText_CantEscape2[] = _("도망칠 수 없다!\p");
static const u8 sText_AttackerCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n도망칠 수 없다!");
static const u8 sText_HitXTimes[] = _("{B_BUFF1}번 맞았다!");
static const u8 sText_PkmnFellAsleep[] = _("{B_EFF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n잠들어 버렸다!");
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY} 때문에\n{B_EFF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 잠들어 버렸다!");
static const u8 sText_PkmnAlreadyAsleep[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n이미 잠들어 있다");
static const u8 sText_PkmnAlreadyAsleep2[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n이미 잠들어 있다");
static const u8 sText_PkmnWasntAffected[] = _("{B_DEF_NAME_WITH_PREFIX}에게는\n전혀 효과가 없다!");
static const u8 sText_PkmnWasPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX}의\n몸에 독이 퍼졌다!");
static const u8 sText_PkmnPoisonedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY} 때문에\n{B_EFF_NAME_WITH_PREFIX}의 몸에 독이 퍼졌다!");
...
static const u8 sText_PkmnWasDefrostedBy[] = _("{B_ATK_NAME_WITH_PREFIX}의\n{B_CURRENT_MOVE} 때문에 얼음이 녹았다!");
static const u8 sText_PkmnWasParalyzed[] = _("{B_EFF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 마비되어\n기술이 나오기 어려워졌다!");
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY} 때문에\n{B_EFF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 마비되어\l기술이 나오기 어려워졌다!");
static const u8 sText_PkmnIsParalyzed[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n몸이 저려서 움직일 수 없다!");
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n이미 마비되어 있다");
...
static const u8 sText_TeamStoppedWorking[] = _("우리 편 {B_BUFF1}{B_TXT_IGA}\n멈췄다!");
static const u8 sText_FoeStoppedWorking[] = _("상대 {B_BUFF1}{B_TXT_IGA}\n멈췄다!");
...
static const u8 sText_PkmnAlreadyConfused[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 이미\n혼란에 빠져 있다");
static const u8 sText_PkmnFellInLove[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n헤롱헤롱해졌다!");
static const u8 sText_PkmnInLove[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}에게 헤롱헤롱해 있다!");
static const u8 sText_PkmnImmobilizedByLove[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n헤롱헤롱해서 기술을 쓸 수 없었다!");
...
static const u8 sText_PkmnFlinched[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n풀이 죽어 기술을 쓸 수 없다!");
static const u8 sText_PkmnRegainedHealth[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 체력을 회복했다!");
static const u8 sText_PkmnHPFull[] = _("{B_DEF_NAME_WITH_PREFIX}의\n체력은 가득 찼다!");
static const u8 sText_PkmnRaisedSpDef[] = _("{B_ATK_PREFIX2}의 {B_CURRENT_MOVE} 때문에\n특수방어가 올랐다!");
static const u8 sText_PkmnRaisedSpDefALittle[] = _("{B_ATK_PREFIX2}의 {B_CURRENT_MOVE} 때문에\n특수방어가 조금 올랐다!");
static const u8 sText_PkmnRaisedDef[] = _("{B_ATK_PREFIX2}의 {B_CURRENT_MOVE} 때문에\n방어가 올랐다!");
static const u8 sText_PkmnRaisedDefALittle[] = _("{B_ATK_PREFIX2}의 {B_CURRENT_MOVE} 때문에\n방어가 조금 올랐다!");
static const u8 sText_PkmnCoveredByVeil[] = _("{B_ATK_PREFIX2}{B_TXT_EUNNEUN}\n신비의 베일에 둘러싸였다!");
static const u8 sText_PkmnUsedSafeguard[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EULREUL}\n신비의 베일이 지켜주고 있다!");
static const u8 sText_PkmnSafeguardExpired[] = _("{B_ATK_PREFIX3}{B_TXT_EULREUL} 감싸던\n신비의 베일이 없어졌다!");
...
static const u8 sText_PkmnClamped[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_DEF_NAME_WITH_PREFIX}의 껍질에 꼈다!");
...
const u8 gText_PkmnShroudedInMist[] = _("{B_ATK_PREFIX2}{B_TXT_EUNNEUN}\n흰안개에 둘러싸였다!");
...
static const u8 sText_PkmnBuffetedBySandstorm[] = _("모래바람이\n{B_ATK_NAME_WITH_PREFIX}{B_TXT_EULREUL} 덮쳤다!");
static const u8 sText_PkmnPeltedByHail[] = _("싸라기눈이\n{B_ATK_NAME_WITH_PREFIX}{B_TXT_EULREUL} 덮쳤다!");
static const u8 sText_PkmnsXWoreOff[] = _("{B_ATK_PREFIX1}의 {B_BUFF1}{B_TXT_IGA}\n그쳤다!");
...
static const u8 sText_PkmnWokeUp[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n눈을 떴다!");
static const u8 sText_PkmnUproarKeptAwake[] = _("그러나 {B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n소란스러워서 잠들 수 없다!");
static const u8 sText_PkmnWokeUpInUproar[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n소란스러워서 눈을 떴다!");
static const u8 sText_PkmnCausedUproar[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n소란을 피우기 시작했다!");
static const u8 sText_PkmnMakingUproar[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n소란을 피우고 있다!");
...
static const u8 sText_UproarKeptPkmnAwake[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n소란스러워서 눈을 떴다!");
static const u8 sText_PkmnStayedAwakeUsing[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_DEF_ABILITY} 때문에 잠들지 않는다!");
static const u8 sText_PkmnStoringEnergy[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 참고 있다");
...
static const u8 sText_PkmnPickedUpItem[] = _("{B_PLAYER_NAME}{B_TXT_EUNNEUN} {B_BUFF1}원을 주웠다!\p");
...
static const u8 sText_PkmnSubstituteFaded[] = _("{B_DEF_NAME_WITH_PREFIX}의\n대타는 사라져 버렸다...\p");
static const u8 sText_PkmnMustRecharge[] = _("공격의 반동으로\n{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 움직일 수 없다!");
static const u8 sText_PkmnRageBuilding[] = _("{B_DEF_NAME_WITH_PREFIX}의 분노\n볼티지가 올라가고 있다!");
static const u8 sText_PkmnMoveWasDisabled[] = _("{B_DEF_NAME_WITH_PREFIX}의 {B_BUFF1}{B_TXT_EULREUL} 봉인했다!");
...
static const u8 sText_PkmnStoleItem[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_DEF_NAME_WITH_PREFIX}의 {B_LAST_ITEM}{B_TXT_EULREUL} 빼앗았다!");
...
static const u8 sText_SpikesScattered[] = _("{B_DEF_PREFIX2}의 발밑에\n압정이 뿌려졌다!");
...
static const u8 sText_PkmnShedLeechSeed[] = _("{B_ATK_NAME_WITH_PREFIX}에게\n씨앗을 심었다!");
static const u8 sText_PkmnBlewAwaySpikes[] = _("{B_ATK_NAME_WITH_PREFIX}의\n압정이 사라졌다!");
static const u8 sText_PkmnFledFromBattle[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n배틀에서 이탈했다!");
...
static const u8 sText_PkmnObtainedXYObtainedZ[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_BUFF1}{B_TXT_EULREUL} 손에 넣었다!\p{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_BUFF2}{B_TXT_EULREUL} 손에 넣었다!");
...
static const u8 sText_TheWallShattered[] = _("벽이 깨졌다!");
static const u8 sText_ButNoEffect[] = _("그러나 효과가 없었다!");
...
static const u8 sText_PkmnMadeItRain[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY}\n때문에 비가 내리기 시작했다!");
static const u8 sText_PkmnRaisedSpeed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY}\n때문에 스피드가 올라갔다!");
...
static const u8 sText_PkmnsXMadeYUseless[] = _("{B_DEF_NAME_WITH_PREFIX}의 {B_DEF_ABILITY}\n때문에 {B_CURRENT_MOVE}{B_TXT_EUNNEUN} 효과가 없었다!");
static const u8 sText_PkmnChangedTypeWith[] = _("{B_DEF_NAME_WITH_PREFIX}의 {B_DEF_ABILITY} 때문에\n{B_BUFF1}타입이 되었다!");
...
static const u8 sText_ItSuckedLiquidOoze[] = _("해감액을 흡수했다!");
...
static const u8 sText_PreventedFromWorking[] = _("{B_DEF_NAME_WITH_PREFIX}의\n{B_DEF_ABILITY} 때문에\l{B_SCR_ACTIVE_NAME_WITH_PREFIX}의\l{B_BUFF1}{B_TXT_EUNNEUN} 효과가 없었다!");
static const u8 sText_PkmnsXMadeItIneffective[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의\n{B_SCR_ACTIVE_ABILITY} 때문에 실패했다!");
static const u8 sText_PkmnsXPreventsFlinching[] = _("{B_EFF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_EFF_ABILITY} 때문에\n풀이 죽지 않는다!");
...
static const u8 sText_UsingXTheYOfZN[] = _("{B_LAST_ITEM}{B_TXT_EU}로 {B_SCR_ACTIVE_NAME_WITH_PREFIX}의\n{B_BUFF1}{B_TXT_IGA} {B_BUFF2}");
...
static const u8 sText_StatsWontIncrease2[] = _("{B_ATK_NAME_WITH_PREFIX}의 {B_BUFF1}{B_TXT_EUNNEUN}\n더 올라가지 않는다!");
static const u8 sText_StatsWontDecrease2[] = _("{B_DEF_NAME_WITH_PREFIX}의 {B_BUFF1}{B_TXT_EUNNEUN}\n더 올라가지 않는다!");
static const u8 sText_CriticalHit[] = _("급소에 맞았다!");
static const u8 sText_OneHitKO[] = _("일격필살!");
...
static const u8 sText_NotVeryEffective[] = _("효과가 별로인 듯하다");
static const u8 sText_SuperEffective[] = _("효과가 굉장했다!");
...
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE 0x0049}아나운서: 딩동-!\n사파리볼이 전부 떨어졌으므로\l종료입니다-!\p");
static const u8 sText_OpponentMon1Appeared[] = _("{B_OPPONENT_MON1_NAME} appeared!\p");
static const u8 sText_WildPkmnAppeared[] = _("앗! 야생 {B_OPPONENT_MON1_NAME}{B_TXT_IGA} 튀어나왔다!\p");
static const u8 sText_WildPkmnAppeared2[] = _("앗! 야생 {B_OPPONENT_MON1_NAME}{B_TXT_IGA} 튀어나왔다!\p");
...
static const u8 sText_LinkPartnerSentOutPkmnGoPkmn[] = _("{B_LINK_PARTNER_NAME}{B_TXT_EUNNEUN}\n{B_LINK_PLAYER_MON2_NAME}{B_TXT_EULREUL} 꺼냈다!\n가랏! {B_LINK_PLAYER_MON1_NAME}!");
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1} 좋아!\n돌아와!");
...
static const u8 sText_FoePkmnPrefix2[] = _("상대의");
static const u8 sText_AllyPkmnPrefix[] = _("우리 편의");
...
static const u8 sText_AttackerUsedX[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}(의)\n{B_BUFF2}"); // fixme {B_BUFF1}를 사용하면 (의) 출력이 가능하나 "를 썼다!"라고 출력되는 기술 사용 시 멈춤 현상이 일어남.
...
static const u8 sText_HP2[] = _("체력");
static const u8 sText_Attack2[] = _("공격");
static const u8 sText_Defense2[] = _("방어");
static const u8 sText_Speed[] = _("스피드");
static const u8 sText_SpAtk2[] = _("특수공격");
static const u8 sText_SpDef2[] = _("특수방어");
...
static const u8 sText_Lanettes[] = _("보은의");
...
static const u8 sText_PkmnsItemCuredParalysis[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 마비가 풀렸다!");
static const u8 sText_PkmnsItemCuredPoison[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 독이 해독됐다!");
static const u8 sText_PkmnsItemHealedBurn[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 화상이 나았다!");
static const u8 sText_PkmnsItemDefrostedIt[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 얼음상태가 나았다!");
static const u8 sText_PkmnsItemWokeIt[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 잠에서 깼다!");
static const u8 sText_PkmnsItemSnappedOut[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 혼란이 풀렸다!");
static const u8 sText_PkmnsItemCuredProblem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 {B_BUFF1}상태가 나았다!");
static const u8 sText_PkmnsItemNormalizedStatus[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 상태이상이 나았다!");
static const u8 sText_PkmnsItemRestoredHealth[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 체력을 회복했다!");
static const u8 sText_PkmnsItemRestoredPP[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 {B_BUFF1}의 PP를 회복했다!");
static const u8 sText_PkmnsItemRestoredStatus[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 상태를 원래대로 되돌렸다!");
static const u8 sText_PkmnsItemRestoredHPALittle[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 조금 회복했다");
static const u8 sText_ItemAllowsOnlyYMove[] = _("{B_LAST_ITEM}의 효과로\n{B_CURRENT_MOVE}밖에 쓸 수 없다!\p");
static const u8 sText_PkmnHungOnWithX[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN}\n{B_LAST_ITEM}{B_TXT_EU}로 버텼다!");
