...
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY} 때문에\n도망칠 수 없다!\p"); // §ての §はでｎにげられない!ｐ
...
static const u8 sText_PkmnSqueezedByBind[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_ATK_NAME_WITH_PREFIX}에게\n조이기를 당했다!"); // §たは §そにｎしめつけられた!
...
static const u8 sText_PkmnWrappedBy[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_ATK_NAME_WITH_PREFIX}에게\n휘감겼다!");
static const u8 sText_PkmnClamped[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_ATK_NAME_WITH_PREFIX}의\n껍질에 꼈다!");
...
static const u8 sText_PkmnPickedUpItem[] = _("{B_PLAYER_NAME}{B_TXT_EUNNEUN} {B_BUFF1}원을\n주웠다!\p"); // §もは § ￥ｎひろった!ｐ
...
static const u8 sText_PkmnHasSubstitute[] = _("그러나 {B_ATK_NAME_WITH_PREFIX}의\n대타는 이미 나와있다!"); // しかし §そのｎみがわりは すでに でていた!
...
static const u8 sText_PkmnLaidCurse[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 자신의 체력을\n깎아서 {B_DEF_NAME_WITH_PREFIX}에게 저주를 걸었다!");
...
static const u8 sText_PkmnStatusNormal[] = _("{B_ATK_NAME_WITH_PREFIX}의 상태 이상이\n나았다!");
...
static const u8 sText_PkmnObtainedX[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_BUFF1}{B_TXT_EULREUL}\n손에 넣었다!");
static const u8 sText_PkmnObtainedX2[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_BUFF2}{B_TXT_EULREUL}\n손에 넣었다!");
...
static const u8 sText_XFoundOneY[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_LAST_ITEM}{B_TXT_EULREUL}\n주워 왔다!"); // §そは §にをｎひろってきた!
static const u8 sText_SoothingAroma[] = _("기분 좋은 향기가 퍼졌다!"); // ここちよい かおりが ひろがった!
...
static const u8 sText_PkmnCantUseMoveTorment[] = _("{B_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 트집을 잡혔기 때문에\n계속해서 같은 기술을 쓸 수 없다!\p");
...
static const u8 sText_PkmnPreventsUsage[] = _("{B_DEF_NAME_WITH_PREFIX}의 {B_DEF_ABILITY} 때문에\n{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_CURRENT_MOVE}{B_TXT_EULREUL} 할 수 없다!");
static const u8 sText_PkmnRestoredHPUsing[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_DEF_ABILITY}{B_TXT_EU}로 인해\n회복했다!");
...
static const u8 sText_PkmnPreventsParalysisWith[] = _("{B_EFF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_DEF_ABILITY} 때문에\n마비되지 않는다!"); // §ちは §のでｎまひしない!
static const u8 sText_PkmnPreventsRomanceWith[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_DEF_ABILITY} 때문에\n헤롱헤롱해지지 않는다!");
static const u8 sText_PkmnPreventsPoisoningWith[] = _("{B_EFF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_DEF_ABILITY} 때문에\n독에 걸리지 않는다!");
static const u8 sText_PkmnPreventsConfusionWith[] = _("{B_DEF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_DEF_ABILITY} 때문에\n혼란되지 않는다!");
...
static const u8 sText_PkmnsXBlocksY2[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_SCR_ACTIVE_ABILITY} 때문에\n{B_CURRENT_MOVE}{B_TXT_EULREUL} 받지 않는다!");
static const u8 sText_PkmnsXRestoredHPALittle2[] = _("{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_ATK_ABILITY}{B_TXT_EU}로 인해\n조금 회복했다");
static const u8 sText_PkmnsXWhippedUpSandstorm[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY} 때문에\n모래바람이 불었다!");
static const u8 sText_PkmnsXIntensifiedSun[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY} 때문에\n햇살이 강해졌다!");
...
static const u8 sText_PkmnsXInfatuatedY[] = _("{B_DEF_NAME_WITH_PREFIX}의 {B_DEF_ABILITY} 때문에\n{B_ATK_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} 헤롱헤롱해졌다!");
static const u8 sText_PkmnsXMadeYIneffective[] = _("{B_DEF_NAME_WITH_PREFIX}의 {B_DEF_ABILITY} 때문에\n{B_CURRENT_MOVE}{B_TXT_EUNNEUN} 효과가 없다!");
...
static const u8 sText_PreventedFromWorking[] = _("{B_DEF_NAME_WITH_PREFIX}의 {B_DEF_ABILITY} 때문에\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_BUFF1}{B_TXT_EUNNEUN} 효과가 없었다!"); // §たの §のでｎ§ての § は きかなかった!
static const u8 sText_PkmnsXMadeItIneffective[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}의 {B_SCR_ACTIVE_ABILITY} 때문에\n실패했다!");
static const u8 sText_PkmnsXPreventsFlinching[] = _("{B_EFF_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_EFF_ABILITY} 때문에\n풀이 죽지 않는다!");
static const u8 sText_PkmnsXPreventsYsZ[] = _("{B_ATK_NAME_WITH_PREFIX}의 {B_ATK_ABILITY} 때문에\n{B_DEF_NAME_WITH_PREFIX}의 {B_DEF_ABILITY}{B_TXT_EUNNEUN} 효과가 없다!");
static const u8 sText_PkmnsXCuredItsYProblem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}{B_TXT_EUNNEUN} {B_SCR_ACTIVE_ABILITY} 때문에\n{B_BUFF1}{B_TXT_IGA} 나았다!");
...
static const u8 sText_HMMovesCantBeForgotten[] = _("그건 중요한 기술입니다\n잊게 할 수 없습니다!\p"); // それは たいせつな わざですｎわすれさせることは できません!ｐ
...
static const u8 sText_PkmnCuriousAboutX[] = _("{B_OPPONENT_MON1_NAME}{B_TXT_EUNNEUN} {B_BUFF1}에\n흥미가 있는 듯하다!");
static const u8 sText_PkmnEnthralledByX[] = _("{B_OPPONENT_MON1_NAME}{B_TXT_EUNNEUN} {B_BUFF1}에\n푹 빠진 모양이다!");
static const u8 sText_PkmnIgnoredX[] = _("{B_OPPONENT_MON1_NAME}{B_TXT_EUNNEUN} {B_BUFF1}에\n눈길도 주지 않는다!");
static const u8 sText_ThrewPokeblockAtPkmn[] = _("{B_PLAYER_NAME}{B_TXT_EUNNEUN}\n{B_OPPONENT_MON1_NAME}에게 포켓몬스넥을 던졌다!");
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE 0x0049}방송: 딩동! 사파리볼을\n다 썼으므로 종료합니다-!\p"); // アナウンス『ピンポ-ン! サファリボ-ルがｎなくなったので しゅうりょうで-す!ｐ
...
static const u8 sText_LinkPartnerSentOutPkmnGoPkmn[] = _("{B_LINK_PARTNER_NAME}{B_TXT_EUNNEUN} {B_LINK_PLAYER_MON2_NAME}{B_TXT_EULREUL} 내보냈다!\n가랏! {B_LINK_PLAYER_MON1_NAME}!");
...
static const u8 sText_Attack2[] = _("공격력"); // こうげきりょく
static const u8 sText_Defense2[] = _("방어력"); // ぼうぎょりょく
...
static const u8 sText_PkmnSentToPC[] = _("{B_OPPONENT_MON1_NAME}{B_TXT_EUNNEUN} {B_PC_CREATOR_NAME} PC로\n전송되었다!");
