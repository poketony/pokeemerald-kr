...
static const u8 sText_PkmnShedLeechSeed[] = _("{B_ATK_NAME_WITH_PREFIX}{NEUN_EUN}\n씨앗을 날려버렸다!");
static const u8 sText_PkmnBlewAwaySpikes[] = _("{B_ATK_NAME_WITH_PREFIX}{NEUN_EUN}\n압정을 날려버렸다!");
