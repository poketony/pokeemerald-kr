...
static void Select_PrintSelectMonString(void)
{
    ...
    AddTextPrinterParameterized(2, 7, str, 2, 5, 0, NULL);
...
{
    FillWindowPixelBuffer(2, PIXEL_FILL(0));
    AddTextPrinterParameterized(2, 7, gText_CantSelectSamePkmn, 2, 5, 0, NULL);
    CopyWindowToVram(2, 2);
}
...
static void Select_PrintMenuOptions(void)
{
    ...
    AddTextPrinterParameterized3(3, 7, 7, 1, sMenuOptionTextColors, 0, gText_Summary);
    if (selectedId != 0)
        AddTextPrinterParameterized3(3, 7, 7, 17, sMenuOptionTextColors, 0, gText_Deselect);
    else
        AddTextPrinterParameterized3(3, 7, 7, 17, sMenuOptionTextColors, 0, gText_Rent);

    AddTextPrinterParameterized3(3, 7, 7, 33, sMenuOptionTextColors, 0, gText_Others2);
...
static void Select_PrintYesNoOptions(void)
{
    ...
    AddTextPrinterParameterized3(4, 7, 7, 1, sMenuOptionTextColors, 0, gText_Yes2);
    AddTextPrinterParameterized3(4, 7, 7, 17, sMenuOptionTextColors, 0, gText_No2);
