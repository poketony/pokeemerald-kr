...
const u32 gHealthboxLevelPlaceholderGfx[] = INCBIN_U32("graphics/battle_interface/healthbox_level_placeholder.4bpp");
...
const u32 gBuyMenuFramePal[] = INCBIN_U32("graphics/interface/mart_frame.gbapal.lz");
