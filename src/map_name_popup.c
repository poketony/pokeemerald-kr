...
static const u8 gText_PyramidFloor1[] = _("피라미드 1층");
static const u8 gText_PyramidFloor2[] = _("피라미드 2층");
static const u8 gText_PyramidFloor3[] = _("피라미드 3층");
static const u8 gText_PyramidFloor4[] = _("피라미드 4층");
static const u8 gText_PyramidFloor5[] = _("피라미드 5층");
static const u8 gText_PyramidFloor6[] = _("피라미드 6층");
static const u8 gText_PyramidFloor7[] = _("피라미드 7층");
static const u8 gText_Pyramid[] = _("피라미드");
...
static void ShowMapNamePopUpWindow(void)
{
    ...
    x = GetStringCenterAlignXOffset(1, withoutPrefixPtr, 80);
    mapDisplayHeader[0] = EXT_CTRL_CODE_BEGIN;
    mapDisplayHeader[1] = EXT_CTRL_CODE_HIGHLIGHT;
    mapDisplayHeader[2] = TEXT_COLOR_TRANSPARENT;
    AddTextPrinterParameterized(GetMapNamePopUpWindowId(), 1, mapDisplayHeader, x, 3, 0xFF, NULL);
