...
static void TextSpeed_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_TextSpeedSlow, 96, YPOS_TEXTSPEED, styles[0]);
    ...
    widthMid -= 102;
    xMid = (widthSlow - widthMid - widthFast) / 2 + 96;
...
static void BattleScene_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleSceneOn, 96, YPOS_BATTLESCENE, styles[0]);
...
static void BattleStyle_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleStyleShift, 96, YPOS_BATTLESTYLE, styles[0]);
...
static void Sound_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_SoundMono, 96, YPOS_SOUND, styles[0]);
...
static void FrameType_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_FrameType, 96, YPOS_FRAMETYPE, 0);
    DrawOptionMenuChoice(text, 120, YPOS_FRAMETYPE, 1);
}
...
static void ButtonMode_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_ButtonTypeNormal, 96, YPOS_BUTTONMODE, styles[0]);
