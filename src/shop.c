...
EWRAM_DATA u8 (*gUnknown_02039F78)[ITEM_NAME_LENGTH] = {0};
...
static void BuyMenuPrint(u8 windowId, const u8 *text, u8 x, u8 y, s8 speed, u8 colorSet)
{
    AddTextPrinterParameterized4(windowId, 7, x, y, 0, 0, sShopBuyMenuTextColors[colorSet], speed, text);
}
...
static void BuyMenuPrintItemQuantityAndPrice(u8 taskId)
{
    ...
    PrintMoneyAmount(4, 33, 1, gShopDataPtr->totalCost, TEXT_SPEED_FF);
